...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/Mell-com/GScan/constant.Version=$(VERSION)" \
		-X "github.com/Mell-com/GScan/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
